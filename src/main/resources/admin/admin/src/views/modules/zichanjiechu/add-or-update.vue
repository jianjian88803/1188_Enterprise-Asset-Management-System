<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借出日期" prop="jiechuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiechuriqi" 
                type="date"
                placeholder="借出日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiechuriqi" label="借出日期" prop="jiechuriqi">
              <el-input v-model="ruleForm.jiechuriqi" 
                placeholder="借出日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借出备注" prop="jiechubeizhu">
          <el-input v-model="ruleForm.jiechubeizhu" 
              placeholder="借出备注" clearable  :readonly="ro.jiechubeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借出备注" prop="jiechubeizhu">
              <el-input v-model="ruleForm.jiechubeizhu" 
                placeholder="借出备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.jiechuriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='jiechuriqi'){
            this.ruleForm.jiechuriqi = obj[o];
	    this.ro.jiechuriqi = true;
            continue;
          }
          if(o=='jiechubeizhu'){
            this.ruleForm.jiechubeizhu = obj[o];
	    this.ro.jiechubeizhu = true;
            continue;
          }
          if(o=='yonghuming'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zichanjiechu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichanjiechuCrossAddOrUpdateFlag = false;
                  this.parent.search();
